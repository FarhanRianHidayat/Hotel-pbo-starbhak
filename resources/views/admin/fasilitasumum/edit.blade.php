...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        ...
        <div class="card-body">
            <form class="forms-sample" action="/fasilitasumum/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="1">Fasilitas</label>
                    <input type="text" class="form-control" id="1" placeholder="Name" name="nama" value="{{ $data->nama }}">
                </div>
                <div class="form-group">
                    <label for="2">Keterangan</label>
                    <textarea class="form-control" id="2" rows="4" name="keterangan">{{ $data->keterangan }}</textarea>
                </div>
                <div class="form-group">
